...
--角色信息
MyPlayer=allpb_pb.PlayerInfo();

--初始化完成，发送链接服务器信息--
function Game.OnInitOK()
    AppConst.SocketPort = 1234;
    AppConst.SocketAddress = "192.168.43.115";
    ...
    --通用tips面板加载
    OpenPanel(CtrlNames.Tips);

    --游戏封面加载
    OpenPanel(CtrlNames.Title);
...
function Game.OnPbluaCall(data)
    local msg = allpb_pb.LoginRequest();
