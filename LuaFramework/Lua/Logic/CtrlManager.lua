...
require "Controller/TitleCtrl"
require "Controller/TipsCtrl"
require "Controller/CreatePlayerCtrl"
...
function CtrlManager.Init()
	...
	ctrlList[CtrlNames.Title]=TitleCtrl.New();
	ctrlList[CtrlNames.Tips]=TipsCtrl.New();
	ctrlList[CtrlNames.CreatePlayer]=CreatePlayerCtrl.New() ;
