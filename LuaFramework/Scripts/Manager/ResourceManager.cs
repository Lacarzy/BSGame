...
namespace LuaFramework {
    ...
    public class ResourceManager : Manager {
        ...
        public void LoadSprite(string abName, string[] assetNames, LuaFunction func,GameObject obj=null)
        {
            LoadAsset<Sprite>(abName, assetNames, null, func,obj);
        }
        ...
        /// 载入素材
        /// </summary>
        void LoadAsset<T>(string abName, string[] assetNames, Action<UObject[]> action = null, LuaFunction func = null,GameObject obj=null) where T : UObject {
        ...
        IEnumerator OnLoadAsset<T>(string abName) where T : UObject {
            ...
            for (int i = 0; i < list.Count; i++) {
                ...
                if (list[i].luaFunc != null) {
                    list[i].luaFunc.Call((object)result,list[i].obj);
